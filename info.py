...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-5180901533')  # Support group id (make sure bot is admin)
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1003564476027')  # Request channel id (make sure bot is admin)
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+9XDDon0YzvVlNTM9')  # Support group link (make sure bot is admin)
