...
# FORCE_SUB 
auth_req_channels = environ.get("AUTH_REQ_CHANNELS", "-1003783578678")# requst to join Channel for force sub (make sure bot is admin) only for bot ADMINS  
auth_channels     = environ.get("AUTH_CHANNELS", "-1003701904881")# Channels for force sub (make sure bot is admin)

# ============================
# Payment Configuration
# ============================
QR_CODE = environ.get('QR_CODE', 'https://t.me/MK_BOTS1/6')    # QR code image for payments
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', 'ɴᴏ ᴀᴠᴀɪʟᴀʙʟᴇ ʀɪɢʜᴛ ɴᴏᴡ so dm me : @otcoffix [ PLZ DM BEFORE PAYING MONEY ✨]')    # Owner UPI ID for payments
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+kfOKwNlWu8BmZDc1') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/otcoffix') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/MK_BOTS1') # Update channel link for the bot
...
CUSTOM_FILE_CAPTION = environ.get("CAPTION")   # Cutom caption for files
BATCH_FILE_CAPTION = environ.get("CAPTION", CUSTOM_FILE_CAPTION) # Custom caption for batch files
