...
PICS = (environ.get('PICS', 'https://t.me/mahibai0/6812 https://t.me/mahibai0/6810 https://t.me/CARTOON_NETWORK_TAMIL1/35')).split()  # Sample pic
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/OLDTAMILCARTOONS') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/otcoffix') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/OLDTAMILCARTOONS') # Update channel link for the bot
...
CUSTOM_FILE_CAPTION = environ.get("All files are provided by : @OLDTAMILCARTOONS 📁", f"{script.CAPTION}")   # Custom caption for files
