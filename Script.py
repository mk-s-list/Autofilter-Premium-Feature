...
"""
    ...
    GSTART_TXT = """<b>🚩யாதும் ஊரே யாவரும் கேளிர்🚩</b>
...
⟡ʏᴏᴜ ᴄᴀɴ ᴇᴀʀɴ ᴍᴏɴᴇʏ ʙᴜᴛ ᴜsɪɴɢ ᴛʜɪs ʙᴏᴛ ғᴏʀ ғʀᴇᴇ
⟡ᴛʜɪs ɪs ᴀɴ ᴘᴜʙʟɪᴄ ʙᴏᴛ sᴏ ᴀɴʏᴏɴᴇ ᴄᴀɴ ᴜsᴇ ɪᴛ
─── ❖ ───
🩵ʜᴏᴡ ᴛᴏ ᴇᴀʀɴ ᴍᴏɴᴇʏ🩵
𝘧𝘰𝘭𝘭𝘰𝘸 𝘵𝘩𝘦 𝘴𝘵𝘦𝘱𝘴... 

❱ ᴄʀᴇᴀᴛᴇ ᴀ ᴛᴇʟᴇɢʀᴀᴍ ᴍᴏᴠɪᴇ ɢʀᴏᴜᴘ
❱ ᴀᴅᴅ ʙᴏᴛ ᴛᴏ ᴛʜᴀᴛ ɢʀᴏᴜᴘ ᴡɪᴛʜ ᴀʟʟ ᴀᴅᴍɪɴ ʀɪɢʜᴛs
❱ ᴄʀᴇᴀᴛᴇ ᴀ ᴀᴄᴄᴏᴜɴᴛ ɪɴ ᴀ ʟɪɴᴋ sʜᴏʀᴛɴᴇʀ
❱ ᴄᴏᴘʏ ᴛʜᴇ ᴀᴘɪ. ᴛʜᴇɴ ᴄᴏᴍᴇ ʙᴀᴄᴋ ᴛᴏ ɢʀᴏᴜᴘ
❱ ᴜsᴇ ᴛʜᴇ sᴇᴛ sʜᴏʀᴛᴇʀ ᴄᴏᴍᴍᴀɴᴅ
❱ sᴇᴛᴜᴘ ᴀᴘɪ... 
...
├⍟ ᴏᴜʀ ᴡᴇʙsɪᴛᴇ: <a href='https://mkbots.blogspot.com/2026/02/mk-link-shortener-earn-from-your-links.html'>ʟɪɴᴋ sʜᴏʀᴛɴᴇʀ ᴡᴇʙ</a> 
...
<blockquote>👇 KELLA IRUKA ETHACHU MAANU PARU THALA 👇</blockquote>"""
...
<blockquote>
➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖
𝙄𝙁 𝙐 𝘾𝘼𝙉'𝙏 𝙁𝙄𝙉𝘿 𝙏𝙃𝙀 𝙁𝙄𝙇𝙀 𝙔𝙊𝙐 𝙒𝘼𝙉𝙏 𝙋𝙇𝙕 𝙏𝙀𝙇𝙇 𝙐𝙎 𝙒𝙀 𝙒𝙄𝙇𝙇
𝙐𝙋𝙇𝙊𝘿𝙀 𝙏𝙃𝙀𝙈 𝙎𝙊𝙊𝙉... 

𝘾𝙊𝙉𝙏𝘼𝘾𝙏 𝙐𝙎 : @OTC_BEN_BOT
...
<blockquote>THIS MOVIE IS NOT AVAILABLE IN MY DATABASE OR NOT INDEXED BY ME. PLZ TELL US IF WE DONT HAVE THE FILE YOU WANT. CONTACT US : @OTC_BEN_BOT</blockquote>"""
...
•─────•─────────•─────•
🏷️ <a href='https://t.me/OLDTAMILCARTOONS'>ꜱᴜʙꜱᴄʀɪᴘᴛɪᴏɴ ᴘʀᴏᴏꜰ</a>
...
ɪꜰ ʏᴏᴜ ꜰᴀᴄᴇ ᴀɴʏ ᴘʀᴏʙʟᴇᴍ, ᴛᴀᴋᴇ ᴀ ꜱᴄʀᴇᴇɴꜱʜᴏᴛ ᴀɴᴅ ꜱᴇɴᴅ ɪᴛ ᴛᴏ - @MK_BOTS1
...
👨‍💻 ᴄᴏɴᴛᴀᴄᴛ ᴛʜᴇ <a href='https://t.me/otcoffix'>Owner</a> ᴛᴏ ɢᴇᴛ ʏᴏᴜʀ ᴛʀɪᴀʟ.
...
‼️ ᴍᴜsᴛ sᴇɴᴅ sᴄʀᴇᴇɴsʜᴏᴛ ᴀғᴛᴇʀ ᴘᴀʏᴍᴇɴᴛ.</b>"""
    ...
    SOURCE_TXT ="""<b>YOU NEED A BOT LIKE THIS WE WILL MADE ONE FOR YOU</b>

  CONTACT 📞 : @MK_BOTS1.\n
ꜱᴏᴜʀᴄᴇ ᴄᴏᴅᴇ ʜᴇʀᴇ ◉› :<a href=https://t.me/mk_bots1</a>\n """
