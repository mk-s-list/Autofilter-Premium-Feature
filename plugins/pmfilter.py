        ...
        if pm_search:
            ...
            await message.reply_text(
                text=(
                    ...
                    "<blockquote>"
                    " தமிழ் வாழ்க!"
                    "நீங்க மட்டும் இல்ல யாராலும் இந்த BOTல இப்போது SEARCH பண்ண முடியாது. கொச்சிகாம நம்ம GROUPல பொயி SEARCH பண்ணுங்க|"
                    "</blockquote></b>"
    ...
    if query.data.startswith("file"):
        ...
        try:
            ...
            await log_msg.reply_text(
                ...
                quote=True,
                disable_web_page_preview=True,
                reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("🚀 Fast Download 🚀", url=f"https://heavy-aigneis-atulraj-f8668bd9.koyeb.app/watch/file_id={file_id}"),  # we download Link
        ...
        buttons = [[
            InlineKeyboardButton('Source Code 📜', url='https://t.me/otcoffix'),
            InlineKeyboardButton('⇋ ʙᴀᴄᴋ ⇋', callback_data='about')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
